# FILE 4: src\core\s3_handler.py
# src/core/s3_handler.py
# FILE: src/s3_handler.py
# Fixed: PDF downloads now work on WhatsApp Android
# Added ResponseContentType + ResponseContentDisposition to presigned URL
# This forces "download" instead of "inline" – the #1 reason Android WhatsApp fails
import boto3
